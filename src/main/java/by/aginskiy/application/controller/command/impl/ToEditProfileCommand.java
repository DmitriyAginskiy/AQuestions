...
/**
 * Action command to go to the edit profile page.
 *
...
public class ToEditProfileCommand implements Command {
    ...
    public CommandResult execute(HttpServletRequest request, HttpServletResponse response) {
        CommandResult commandResult = new CommandResult(JspPath.EDIT_PROFILE_PAGE, CommandResult.TransitionType.REDIRECT);
        logger.log(Level.DEBUG, "Go to edit profile page");
