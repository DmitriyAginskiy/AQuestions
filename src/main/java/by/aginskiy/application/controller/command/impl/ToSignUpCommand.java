...
/**
 * Action command to go to the registration page.
 *
...
public class ToSignUpCommand implements Command {
    ...
    public CommandResult execute(HttpServletRequest request, HttpServletResponse response) {
        CommandResult commandResult = new CommandResult(JspPath.REGISTRATION_PAGE, CommandResult.TransitionType.REDIRECT);
        logger.log(Level.DEBUG, "Go to registration page");
