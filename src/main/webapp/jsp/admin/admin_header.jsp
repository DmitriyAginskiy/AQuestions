...
<header class="fixed-top">
    <nav class="navbar navbar-expand-lg">
        <div class="container-lg">
            <a href="#" class="navbar-brand"><span class="a-letter">A</span>Questions</a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul class="navbar-nav mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a href="admin_users.do?requested_page=1" class="nav-link"><i class="fa fa-user" aria-hidden="true"></i> <fmt:message key="admin_header.users" /></a>
                    </li>
                    <li class="nav-item">
                        <a href="admin_articles.do?requested_page=1" class="nav-link"><i class="fa fa-newspaper-o" aria-hidden="true"></i> <fmt:message key="admin_header.questions" /></a>
                    </li>
